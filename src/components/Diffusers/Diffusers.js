...
export const Diffusers = ({ diffusers, basket }) => {
  const [hoverStates, setHoverStates] = useState(diffusers.map(() => false));
  const [products, setProducts] = useState(diffusers);
  ...
  return (
    <motion.div
      ...
      className='block'
    >
      <h1 className='title-header'>Диффузоры</h1>
