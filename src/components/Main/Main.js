        ...
        <div>
            ...
            <div className='about-block'>
                <div className='about'>
                    ...
                    <div>
                        <p className='about-text'>Создание компании <b style={{color: "#000"}}>MARSO</b> вдохновлено и буквально дышит морем и солнцем. Отсюда и само название: <b style={{color: "#000"}}>MARSO</b> – это море и солнце (в переводе с итальянского: mà·re – море, sole - солнце). </p>
                    </div>
                </div>
                <div className='about'>
                    <div className='about-title'>
                    ...
                    <div>
                        <p className='about-text'>Ароматы MARSO производятся из качественных и тщательно отобранных ингредиентов. Сырье приобретается в компании <b style={{color: "#000"}}>Parfums Plus,</b> положительно зарекомендовавшей себя на рынке парфюмерии.</p>
                    </div>
                </div>
                <div className='about'>
                    <div className='about-title'>
                    ...
                    <div>
                        <p className='about-text'>Название компании также можно смело перевести как "зарождающаяся жизнь". Каждый день, снова и снова, мы создаем ароматы для жизни. Ароматы <b style={{color: "#000"}}>MARSO</b> насквозь пропитаны энергией главных составляющих жизни - морем и солнцем. </p>
                    </div>
                </div>
                <div className='about'>
                    <div className='about-title'>
                    ...
                    <div>
                        <p className='about-text'>Эта передовая французская компания, специализирующаяся на создании и выпуске парфюмерных композиций, основана в 2002 году Стефаном и Кристофом Гараваньо. <b style={{color: "#000"}}>Parfums Plus</b> расположена в Бар-сюр-Лу, в самом сердце региона Грассе, где созданы ультрасовременные производственные объекты с передовым оборудованием. </p>
                    </div>
                </div>
            </div>
        </div>
