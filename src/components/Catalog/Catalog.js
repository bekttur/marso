...
export const Catalog = ({ searchResult, setSearchResult, basket, setBasket }) => {
    
    const [hoverStates, setHoverStates] = useState([]);
    const [products, setProducts] = useState([]);

    useEffect(() => {
        // When searchResult prop changes, update products and hoverStates
        setProducts(searchResult);
        setHoverStates(Array(searchResult.length).fill(false));
    }, [searchResult]);
